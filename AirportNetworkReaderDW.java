...
public class AirportNetworkReaderDW implements AirportNetworkReaderInterface{
     ...
     */
    @Override
    public GraphADT<AirportInterface, Double> readGraphFromFile(String filename) throws FileNotFoundException,IllegalArgumentException {
        ...
        GraphADT<AirportInterface, Double> graph = new BaseGraph<AirportInterface, Double>();
